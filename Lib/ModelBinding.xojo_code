#tag Module
 Attributes ( "@Guid" = "F544A9FB-F177-4498-9E93-790C55D37B99", "@Copyright" = "(c)2025 - Stefan Watermann", "@Version" = "1.0", "@Author" = "Stefan Watermann", "@Description" = "Model-Binding for WebUiControls" ) Protected Module ModelBinding
