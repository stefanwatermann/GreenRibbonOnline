#tag Module
 Attributes ( "@Guid" = "9EAC44D8-DF52-4CCD-9682-D03904F6F013", "@Version" = "1.0", "@Author" = "Stefan Watermann", "@Copyright" = "(c)2023 watermann IT, Germany", "@Depends" = "File", "@Description" = "Drop-In Modul erweitert die WebApplication Klasse um Methoden eine Configuration-Datei zu verwalten." ) Protected Module WebConfiguration
