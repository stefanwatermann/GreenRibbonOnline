...
Begin WebDialog DialogErrorMessage
   ...
   Begin WebLink lnkSupportMail
      ...
      TabStop         =   True
      Target          =   2
      Text            =   "support@greenribbon.de"
      TextAlignment   =   3
      TextColor       =   &c000000FF
      Tooltip         =   ""
      Top             =   260
      Underline       =   False
      URL             =   "mailto:support@greenribbon.de?subject=GreenRibbon Online - SupportCode #SC#"
      Visible         =   True
      Width           =   202
      _mPanelIndex    =   -1
   End
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub Show(msg as string, internalInfo as string = "n.a.", area as string = "DialogErroMessage")
		  ...
		  Self.lnkSupportMail.URL = Self.lnkSupportMail.URL.Replace("#SC#", supportCode)
